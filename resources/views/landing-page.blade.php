...
<head>
    ...
    <title>Rizal 191 - Portofolio</title>
...
<header>
    <div class="nav-bar">
        <a href="#" class="logo">Rizal Ramadhan</a>
...
<section class="home flex-center" id="home">
    <div class="home-container">
        ...
        <div class="info">
            ...
            <a href="#contact" class="btn">Contact Me <i class="fas fa-arrow-alt-circle-right"></i></a>
        </div>
        ...
        <div class="content flex-center">
            ...
            <div class="about-info">
                <div class="description">
                    <h3>I'm Rizal</h3>
                    <h4>A Lead <span>Front-End Developer</span> based in <span>Indonesia</span></h4>
                    <p>I design and develop services for customers specializing creating stylish, modern websites, web services and online stores. My passion is to design digital user experiences through meaningful interactions. Check out my Portofolio!</p>
                </div>
                ...
                <a href="https://intip.in/CVRandom" class="btn">Download CV <i class="fas fa-download"></i></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="content">
                ...
                <div class="education">
                    ...
                    <ul class="edu-list">
                        <li class="item">
                            ...
                            <p><span>S3 in Information System</span> - Institut Teknologi Sepuluh Nopember, Surabaya</p>
                        </li>
                        <li class="item">
                            <span class="year">2020-2022</span>
                            <p><span>S2 in Information System</span> - Institut Teknologi Sepuluh Nopember, Surabaya</p>
                        </li>
                        <li class="item">
                            <span class="year">2016-2020</span>
                            <p><span>S1 in Information System</span> - Institut Teknologi Sepuluh Nopember, Surabaya</p>
                        </li>
                    </ul>
                </div>
                <div class="education">
                ...
                <div class="education">
                    ...
                    <ul class="edu-list">
                        <li class="item">
                            ...
                            <p><span>Best Developer</span> - Institut Teknologi Sepuluh Nopember</p>
                        </li>
                    </ul>
                    <ul class="edu-list">
                        <li class="item">
            ...
            <div class="skills-info">
                <div class="experience-card">
                    ...
                    <p>I design and develop services for customer of all sizes, specializing in creating stylish, modern webstites.</p>
                </div>
                <div class="experience-card">
                    <div class="upper">
                ...
                <li class="service-container">
                    ...
                    <div class="service-modal flex-center">
                        <div class="service-modal-body">
                            ...
                            <p>Content writing is the process of planing, writing and editing web content, typically for digital marketing purposes</p>
                            <h4>What I provide</h4>
                            <ul>
                ...
                <li class="service-container">
                    ...
                    <div class="service-modal flex-center">
                        <div class="service-modal-body">
                            ...
                            <p>Brand Design can be defined as one of the crucial marketing practices of creating the name, logo, design, and the symbolic elements related to the brand to create a distinctive identity in comparison to the other brands in the market and also providiing impetus to the product differentiation</p>
                            <h4>What I provide</h4>
                            <ul>
                                ...
                                <li><i class="fas fa-check-circle"></i> Business Card & Business Systems</li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li class="service-container">
                    ...
                    <div class="service-modal flex-center">
                        <div class="service-modal-body">
                            ...
                            <p>Web development services are used to design, build, support, and evolve all type of web-based software</p>
                            <h4>What I provide</h4>
                            <ul>
...
<section class="collage section" id="collage">
    <div class="container flex-center">
        <h1 class="section-title-01">Collage</h1>
        <h2 class="section-title-02">Collage</h2>
        <div class="content">
            <p class="collage-description">Discover some of my collage projects.</p>
            <div class="button-container">
                <a href="hello" class="button">Hello</a>
                <a href="js1" class = "button">Js1</a>
                <a href="js2" class ="button">Js2</a>
                <a href="linktree" class ="button">Linktree</a>
                <a href="bootstrap" class ="button">Bootstrap</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="contact-left">
                ...
                <ul class="contact-list">
                    <li>
                        ...
                        <span>+62 851-6363-8113</span>
                    </li>
                    <li>
                        <h3 class="item-title"><i class="fas fa-envelope"></i> Email Address</h3>
                        <span><a href="mailto:rizalramadhan.email@gmail.com">rizalramadhan.email@gmail.com</a></span>
                    </li>
                    <li>
                        <h3 class="item-title"><i class="fas fa-map-marked-alt"></i> Official Address</h3>
                        <span>BME I (Blok A/50), Keputih, Surabaya</span>
                    </li>
                </ul>
            </div>
...
<footer>
    ...
    <div class="footer-copyright group">
        <p>© 2023 by Rizal Ramadhan. All rights reserved.</p>
    </div>
</footer>
